				...
				<div class="table-responsive">
					<table class="table app-table-hover mb-0 text-left">
						...
						<tbody>
							...
							$variantsCount = ServiceVariantsModel::where('sv_id', $list->sv_id)->count();
							if($list->show_front){
								$front = '<span class="badge bg-success">Yes</span>';
							}else{
								$front = '<span class="badge bg-danger">No</span>';
							}
							@endphp
							<tr>
								<td class="cell">{{ $n++ }}</td>
