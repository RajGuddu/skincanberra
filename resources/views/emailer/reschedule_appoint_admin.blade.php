        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; border: 1px solid #e0e0e0;">
          ...
          <tr>
            <td style="padding: 30px;">
              ...
              <p style="color: #555555; font-size: 15px;">You have approved a reschedule request.</p>
              ...
              <table cellpadding="6" cellspacing="0" width="100%" style="border-collapse: collapse; margin-top: 15px;">
                ...
                <tr>
                  <td style="border: 1px solid #ddd;">Old Date & Time:</td>
                  <td style="border: 1px solid #ddd;">{{ $old_date }}</td>
                </tr>
                
              </table>

              <p style="color: #555555; font-size: 15px; margin-top: 20px;">This confirmation email has also been sent to the client.</p>
