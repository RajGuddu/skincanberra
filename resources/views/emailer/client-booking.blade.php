        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; border: 1px solid #e0e0e0;">
          ...
          <tr>
            <td style="padding: 30px;">
              <h2 style="color: #333333; margin-top: 0;">Appointment Request Received – Skin Canberra</h2>
              <p style="color: #555555; font-size: 15px;">Hi {{ $client_name }},</p>
              <p style="color: #555555; font-size: 15px;">Thank you for booking with <strong>Skin Canberra</strong>. We have received your appointment request with the details below:</p>
              ...
              <p style="color: #555555; font-size: 15px;">If you have any questions, feel free to reply to this email.</p>
