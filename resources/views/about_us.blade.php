...
<body>
    ...
    <section class="about-us-panel panel-space">
        <div class="container-fluid">
            ...
            <h2 class="text-center mb-4">{{ $content->about_title ?? '' }}</h2>
            <div class="row g-md-5 g-4 align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <?php /* <p class="line-height-36">At Skin Canberra, we believe beauty starts with <strong>healthy,
                            well-cared</strong>-for <strong>skin</strong> and <strong>hair </strong>. Our goal is to
                        offer treatments that are both <strong>effective</strong> and <strong>gentle</strong> — helping
                        you feel confident in your own skin every day.</p>

                    <p class="line-height-36">From rejuvenating <strong>facials</strong> and flawless
                        <strong>makeup</strong> to soothing hair care and precision <strong>laser treatments</strong>,
                        each service is tailored to your needs. We combine expert techniques with <strong>premium,
                            skin-friendly</strong> products to ensure visible, lasting results.
                    </p>

                    <p class="line-height-36"><strong>Every client is unique</strong>, and so is our approach. We
                        <strong>listen, assess,</strong> and <strong>create</strong> a <strong>personalised
                            plan</strong> that fits your lifestyle and comfort. Step into our calm, welcoming studio and
                        experience beauty done with care, honesty, and precision.
                    </p> */ ?>
    ...
    <section class="our-story panel-space" style="background-color: #F2F2F2;">
        <div class="container-fluid">
            <h2 class="text-center mb-4">{{ $content->sec2_title ?? '' }}</h2>
            {!! $content->sec2_description ?? '' !!}
            <?php /* <p class="line-height-36 mb-5 w-75 mx-auto text-center">Shikha Beauty Studio began with a simple idea:
                professional beauty should
                feel personal. We opened our doors to create a calm, welcoming place where clients get honest advice,
                tailored treatments and real results — without the hard sell.</p> */ ?>

            <div class="row g-md-5 g-4 align-items-center flex-direction-reverce">
                <div class="col-md-5">
                ...
                <div class="col-md-7">
                    <h2 class="text-40 mb-4">{{ $content->sec3_title1 ?? '' }}</h2>
                    <p class="line-height-36">{!! $content->sec3_details1 ?? '' !!}</p>
                </div>

            </div>

            <div class="row g-md-5 g-4 align-items-center mt-4">
                <div class="col-md-7">
                    <h2 class="text-40 mb-4">{{ $content->sec3_title2 ?? '' }}</h2>
                    <p class="line-height-36">{!! $content->sec3_details2 ?? '' !!}</p>
                </div>
